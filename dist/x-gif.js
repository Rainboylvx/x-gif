...
// load the styles
var content = __webpack_require__("8d3c");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add CSS to Shadow Root
var add = __webpack_require__("35d6").default
module.exports.__inject__ = function (shadowRoot) {
  add("3d084407", content, shadowRoot)
};
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/xgif.vue?vue&type=script&lang=js&shadow
...
var SuperGif = __webpack_require__("6024");

/* harmony default export */ var xgifvue_type_script_lang_js_shadow = ({
  data() {
    return {
      sup: null,
      frame: 0
  ...
  methods: {
    idx() {
      if (this.sup) {
        var i = this.sup.get_current_frame();
        console.log(i);
        this.frame = parse_int_default()(i);
      } else this.frame = 3;
    },
...
// CONCATENATED MODULE: ./src/xgif.vue?vue&type=script&lang=js&shadow
 /* harmony default export */ var src_xgifvue_type_script_lang_js_shadow = (xgifvue_type_script_lang_js_shadow); 
// CONCATENATED MODULE: ./src/xgif.vue?shadow



function injectStyles (context) {
  
  var style0 = __webpack_require__("e7c7")
...
var component = normalizeComponent(
  src_xgifvue_type_script_lang_js_shadow,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var xgifshadow = (component.exports);
...
window.customElements.define('x-gif', vue_wc_wrapper(external_Vue_default.a, xgifshadow))
...
var _parseInt = __webpack_require__("e814");
...
*/
var Stream = __webpack_require__("9a18");

var parseGIF = __webpack_require__("9318");
...
module.exports = function (opts) {
  ...
  if (typeof options.auto_play == 'undefined') options.auto_play = !gif.getAttribute('data-autoplay') || gif.getAttribute('data-autoplay') == '1';
  ...
  var doImg = function doImg(img) {
    ...
    var currIdx = _frames.length; //ct = color table, gct = global color table
    ...
    */
    ...
    if (currIdx > 0) {
      if (lastDisposalMethod === 3) {
        ...
        if (disposalRestoreFromIdx !== null) {
          frame.putImageData(_frames[disposalRestoreFromIdx].data, 0, 0);
        } else {
    ...
    for (var i = 0; i < img.pixels.length; i++) {
      var pixel = img.pixels[i]; // imgData.data === [R,G,B,A,R,G,B,A,...]
  ...
  var player = function () {
    ...
    var getNextFrameNo = function getNextFrameNo() {
      ...
      return (i + delta + _frames.length) % _frames.length;
    };
    ...
    var putFrame = function putFrame() {
      ...
      tmpCanvas.getContext("2d").putImageData(_frames[i].data, offset.x, offset.y);
...
// module
exports.push([module.i, ".x-gif{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.button-group,.x-gif{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.button-group .button1{display:inline-block;padding:.35em 1.2em;border:.1em solid #000;margin:0 .3em .3em 0;border-radius:.12em;-webkit-box-sizing:border-box;box-sizing:border-box;text-decoration:none;font-weight:300;color:#000;background-color:#fff;text-align:center;-webkit-transition:all .2s;transition:all .2s;cursor:pointer}.button-group .button1:hover{color:#00f;border-color:#00f}.button-group div.inputClass{display:inline-block;font-size:15px}.button-group input{width:30px;height:100%;border:none;border-bottom:1px solid;outline:none;font-size:15px;text-align:center}.button-group input::-webkit-inner-spin-button,.button-group input::-webkit-outer-spin-button{-webkit-appearance:none}.button-group input[type=number]{-moz-appearance:textfield}", ""]);
...
var lzwDecode = __webpack_require__("9a35"); // The actual parsing; returns an object with properties.
...
var parseGIF = function parseGIF(st, handler) {
  ...
  var readSubBlocks = function readSubBlocks() {
    ...
    var resizeBuffer = function resizeBuffer() {
    ...
    do {
      size = st.readByte(); // Increase buffer size if this would exceed our current size
...
var lzwDecode = function lzwDecode(minCodeSize, data) {
  ...
  var enlargeOutput = function enlargeOutput() {
  ...
  var enlargeBuffer = function enlargeBuffer() {
  ...
  var pushCode = function pushCode(code, last) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("4d42");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_xgif_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default.a); 
